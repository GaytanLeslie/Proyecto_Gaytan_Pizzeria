    ...
    <body>
                <div class="container mt-5">
                    <form action="update.php" method="POST">
                                ...
                                <input type="text" class="form-control mb-3" name="domicilio" placeholder="INGRESA DOMICILIO" value="<?php echo $row['domicilio']  ?>">
                                ...
                                <input type="text" class="form-control mb-3" name="sueldo" placeholder="INGRESA SUELDO" value="<?php echo $row['sueldo']  ?>">
